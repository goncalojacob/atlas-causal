...
import { FIXTURE_DATA, fixtures as fixtureRecords } from './helpers.mjs';
...
async function fixtureAtlas() {
  ...
  return createAtlas({
    ...
    fetchJson: () => Promise.reject(new Error('the page fetches the record itself')),
  });
}

async function page(id, kind, options = {}) {

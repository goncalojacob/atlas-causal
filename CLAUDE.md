...
tools/build-index.mjs      deterministic index: manifest + the hashed core, attribute shards, presence index, search shard, citer directory, sources and review files; and, since H8, the prerendered pages — lib/prerender.mjs is their pure half

...
data/index/manifest.json   GENERATED, never cached: the index's generation, counts, the hashed names below, lanes and one box per lane, roles in use, the two vocabularies, officesByEvent and tenuresByOffice, land epochs, presence shards, attribute shards, history shards

...
data/index/presences-<hash>.json  GENERATED: who held which ground and when, without the outlines; fetched by the territory layer and not at first paint. Absent where a dataset has no presences

...
schema/v1/                 event, edge, source, actor, place, presence, region, bundle; import-map is tool-side
...
src/validate/rules.js      cross-record invariants 2–18 and the warnings; pure
...
tools/new-record.mjs       scaffold a record; --new-place writes an event and its place at once
...
Six record kinds: `event`, `edge`, `source`, `actor`, `place`, `presence`. An

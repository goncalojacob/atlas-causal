...
src/vocab.js               the closed vocabularies: a leaf module with the edge types, the relation types and the lens kinds, and the id patterns built from them. `state.js` imports it rather than copying it

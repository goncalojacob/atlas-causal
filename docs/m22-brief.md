# Build brief — M22: summaries, actors and edges for the imported events, 1975–2025

Written 4 September 2026, evening. Runs after M21. Read, in this order:
...
Every event imported by M20 whose start is **1975 or later**, plus the
imported actors and places they involve. M21 took everything before 1975. Work
...
4. **Retraction is the honest outcome, not a failure.** An event you
   ...
   `docs/m22-retractions.md`. Expect a substantial share — elections
...
Every imported event from 1975 on is either wired (≥2 edges, one outgoing)
...
retracted, edges, actors created) and the literal line `M22 done`; an
"M22" section on PR #1.

...
// `null` is the repository's own index, read as the page reads it: the core and
// every attribute shard, expanded back into lists, which is what
// loadNarratives hands this module. Anything else is a data directory the index
// is built from.
async function topologyOf(dir) {
  if (dir === null) return corpusOf(path.join(ROOT, 'data'));

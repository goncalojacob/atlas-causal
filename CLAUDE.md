...
src/lanes.js               the one file that decides what a lane is: since M77 the packing and nothing else — as many unlabelled rows as it takes for no two bars and no two titles to overlap — and where a bar goes in one

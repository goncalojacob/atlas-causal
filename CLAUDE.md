...
node tools/import/cshapes.mjs --source cshapes_2_gw.topojson   # territories, 1886-2019; rarely
...
schema/v1/                 event, edge, source, actor, presence, region, bundle
...
src/state.js               { year, selected, actor, chain, layers } ⇄ URL query string
